...
> Micciancio: [Introduction to lattices](https://ideas-ncbr.pl/en/events/pqc2024/)
...
For the matrix $A$ we put an SIS lattice as

$$
\Lambda_A = \{\mathbf{x} \in \mathbb{Z}^m \;|\; A\mathbf{x} = \mathbf{0}\} \subset \mathbb{Z}^m.
$$

We obviously note that $A$ is **not** a $\Lambda_A$ lattice basis, but the definition above obviously gives us a group
which is closed under addition and scalar multiplication, which we thus can understand as a lattice. Moreover, we do not
even care about its basis.
