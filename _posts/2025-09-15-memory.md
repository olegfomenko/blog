...
### Valida and Jolt
The Valida [^lita2024valida] and Jolt [^cryptoeprint2023_1216], as the relatively new players in the zkVM industry, leverage the sum-based and grand-products permutation arguments accordingly, while the tuples mapping is implemented using a linear combination with an additional challenge. Obviously, this leads to the lack of performance compared to the RISC Zero of SP1.
...
[^cryptoeprint2023_1216]: Srinath Setty, Justin Thaler, and Riad Wahby. Unlocking the lookup singularity with Lasso. Cryptology ePrint Archive, Paper 2023/1216. 2023.
