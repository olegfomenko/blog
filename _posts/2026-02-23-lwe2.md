...
3. Decryption. The decryption algorithm simply puts $m = c_0s + c_1 \mod t$, which means in our case
...
3. Decryption. The decryption is the same as in symmetric scheme:  $m = c_0s + c_1 \mod t$.
