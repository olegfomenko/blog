...
Using Ring-LWE for ciphers is useful not only because of its resistance to PQ, but also because it allows building
a homomorphic ciphers which supports both addition and multiplication of ciphertexts (yeah, the Fully Homomorphic
Encryption). Unfortunately, because of some limitations the number of such operations is limited, this is why such
schemes are called Somewhat Fully Homomorphic Encryption (SFHE).
...
[^fhe]: Zvika Brakerski and Vinod Vaikuntanathan. "Fully Homomorphic Encryption from Ring-LWE and Security for Key
Dependent Messages". CRYPTO 2011 [URL](https://link.springer.com/chapter/10.1007/978-3-642-22792-9_29)